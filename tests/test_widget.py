...
@pytest.mark.parametrize("input_date_string, expected_output", [
    ...
    ("2023-12-25T14:30", "25.12.2023"),
    ("2023-12-25T14:30:00", "25.12.2023")
])
...
@pytest.mark.parametrize("invalid_input, wanted_exc_info", [
    # нет микросекунд
    ("2023-12-25T14:30:00.abc", "Некорректная дата/время: 2023-12-25T14:30:00.abc"),  # некорректные микросекунды
    ("25-12-2023T14:30:00.000000", "Некорректная дата/время: 25-12-2023T14:30:00.000000"),  # дата в неверном формате
    ("", "Некорректная дата/время: "),  # пустая строка
    ("text", "Некорректная дата/время: text"),  # произвольный текст
    ("2023-02-30T14:30:00.000000", "Некорректная дата/время: 2023-02-30T14:30:00.000000"),  # несуществующая дата, исключение fromisoformat
])
